# Exercise 0
# Write a function, check_if_key_exists, that takes a dictionary and a key as its arguments
# It should return True if the dictionary contains the provided key, False otherwise
...
# Exercise 1
# Write a function, create_dict, that takes a list consisting of two elements representing a key / value pair as its argument
...
# Exercise 2
# Write a function, get_first_n_items, that takes two arguments, a list and a number 'n'
# It should return a new list containing the first 'n' items of the given array
...
# Exercise 3
# Write a function, create_arrow, that takes a string representing a direction ("left", "right", "up" or "down") as its argument
# It should return the corresponding arrow ("←", "→", "↑", "↓")
# You don't need to utilise an dictionary here, but think about how you could do so
...
# Exercise 4
# Write a function, move_item_to_end, that takes two arguments, a list and an index value
# It should return a new list where the item that was previously at the given index is now at the end of the list
...
# Exercise 5
# Write a function, update_user_age, that takes a dictionary representing a user's account information
# A user object will look
# {
#     "admin": false,
#     "username": "xoxoAlexoxo",
#     "personal_details": {"name": "Alex", "age": 39, "favFood": "gooseberry fool"},
# }
...
def test_update_user_age():
    ...
    assert user2 == {
        "admin": true,
        "username": "brum4life",
        "personal_details": {"name": "Poonam", "age": 20, "fav_food": "caviar"},
    }


# Exercise 6
# Write a function, check_infinitive, that takes a string representing a French word as an argument
...
# Exercise 7
# Write a function, collect_plurals, that takes a list of strings as an argument
# It should return a list containing all strings ending with an 's' from the input (retaining the order)
...
# Exercise 8
# Write a function, make_all_admins, that takes a list of 'user' dictionaries as an argument
# Each user will be an dictionary with key of 'name' and 'admin'
# The 'admin' key will have a boolean value
# You should return a list of user objects each with the 'admin' key set to true
